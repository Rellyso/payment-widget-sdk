...
1. Frontend → Identifica-se com merchantId público
   ✅ "merchant-123" (OK ser público)

2. Backend → Valida merchantId na whitelist
...
│  • Usar apenas merchantId público                              │
...
[ ] Validação de merchantId (whitelist)
[ ] Sanitização de inputs
[ ] Logs de todas transações
